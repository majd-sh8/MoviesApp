...
public class Top_Fragment extends Fragment implements MovieItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        movie = new ArrayList<>();
        rv_movies = v.findViewById(R.id.Rv_movies_Top);
    ...
    private void getDataT() {
        StringRequest stringRequest = new StringRequest(Request.Method.GET, MovieApi.TopRatedMovie,
