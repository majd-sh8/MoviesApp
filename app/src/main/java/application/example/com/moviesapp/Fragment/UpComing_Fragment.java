...
public class UpComing_Fragment extends Fragment implements MovieItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        movie = new ArrayList<>();
        rv_movies = v.findViewById(R.id.Rv_moviesUP);
    ...
    private void getDataUpComing() {
        StringRequest stringRequest = new StringRequest(Request.Method.GET, MovieApi.upcoming,
